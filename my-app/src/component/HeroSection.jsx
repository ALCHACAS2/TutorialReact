      ...
      <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
        ...
        <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
          ...
          <p class="mb-8 leading-relaxed">
            Kickstarter biodiesel roof party wayfarers cold-pressed. Palo santo live-edge tumeric scenester copper mug flexitarian. Prism vice offal plaid everyday carry. Gluten-free chia VHS squid
            listicle artisan.
          </p>
